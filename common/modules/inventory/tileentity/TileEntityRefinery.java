package common.modules.inventory.tileentity;

import common.modules.blocks.BlockRefinery;
...
public class TileEntityRefinery extends TileEntity implements ISidedInventory
{
	...
	public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockRefinery.updateRefineryBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
