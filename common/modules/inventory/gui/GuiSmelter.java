...
import common.modules.inventory.container.ContainerSmelter;
...
public class GuiSmelter extends GuiContainer
{
	...
	{
		super(new ContainerSmelter(inventoryPlayer, tileFurnace));
	...
	protected void drawGuiContainerBackgroundLayer(float f, int i, int j) {
		...
		mc.renderEngine.bindTexture(new ResourceLocation("Modules:textures/gui/Smelter.png"));
