...
/**
 * Meta-data item for the 5 Items.
 * 
 * @author BrendanP123
 * @author Sparkst3r
 *
...
public class CoreItems extends Item {
	...
	public static String[] types = new String[] {"filter", "ironPlating", "stabilisingRod", "filterSheet", "infusionChamber", "sheet"};     

	/** Human-Readable names */
	public static String[] names = new String[] {"Filter", "Iron Plating", "Stabilising Rod", "Filter Sheet", "Infusion Chamber", "Sheet"};
