...
public class BlockRefinery extends BlockContainer
{
	...
	public BlockRefinery(int par1, boolean par2)
	{
	...
	{
		return par1 == 1 ? this.side : par1 == 0 ? this.side : (par1 == 1 ? this.front_active : (par1 != par2 ? this.blockIcon : this.front_active));
	}
