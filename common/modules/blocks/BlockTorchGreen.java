...
public class BlockTorchGreen extends Block
{
    ...
    public BlockTorchGreen(int par1)
    {
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon(Reference.MODID + ":" + "greenTorch");
    }
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (l == 1)
        {
            par1World.spawnParticle("slime", d0 - d4, d1 + d3, d2, 0.0D, 0.0D, 0.0D);
            par1World.spawnParticle("slime", d0 - d4, d1 + d3, d2, 0.0D, 0.0D, 0.0D);
        }
        else if (l == 2)
        {
        ...
        {
            par1World.spawnParticle("slime", d0, d1 + d3, d2 - d4, 0.0D, 0.0D, 0.0D);
            par1World.spawnParticle("slime", d0, d1 + d3, d2 - d4, 0.0D, 0.0D, 0.0D);
        }
        else if (l == 4)
        {
        ...
        {
            par1World.spawnParticle("slime", d0, d1, d2, 0.0D, 0.0D, 0.0D);
            par1World.spawnParticle("slime", d0, d1, d2, 0.0D, 0.0D, 0.0D);
        }
    }
}
