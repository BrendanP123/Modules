...
public class MetalStorageRender implements ISimpleBlockRenderingHandler {
    ...
    public void renderInventoryBlock(Block block, int metadata, int modelID, RenderBlocks renderer)
    {
        ...
        RenderUtil.instance();
		RenderUtil.drawFaces(renderer, block, ((BlockStorage) block).textureBackground, true);
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer)
    {
        ...
        t.setBrightness(255);
        RenderUtil.instance().renderAllSides(world, x, y, z, block, renderer, ((BlockStorage) block).textureBackground, true);
    ...
    {
        return RenderID.renderIDIngotStorage;
    }
}
