...
public class ModulesBlock extends BlockModules {
	...
	public ModulesBlock(int par1, Material par3Material, String par4, String par5) {
		super(par1, par3Material, par5);
		setCreativeTab(ModulesCore.Modules);
	...
	public ModulesBlock(int par1, Material par3Material, String par4) {
