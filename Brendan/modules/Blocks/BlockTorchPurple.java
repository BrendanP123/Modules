...
public class BlockTorchPurple extends Block
{
    ...
    public BlockTorchPurple(int par1)
    {
    	super(par1, Material.circuits);
        this.setTickRandomly(true);
        this.setCreativeTab(Modules.creativeTabModulesBlocks);
        this.setUnlocalizedName("PurpleTorch");
    }
    
	@Override
	public void registerIcons(IconRegister par1IconRegister)
    {
        this.blockIcon = par1IconRegister.registerIcon(GlobalValues.MODID + ":" + "purpleTorch");
    }
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (l == 1)
        {
            par1World.spawnParticle("witchMagic", d0 - d4, d1 + d3, d2, 0.0D, 0.0D, 0.0D);
            par1World.spawnParticle("witchMagic", d0 - d4, d1 + d3, d2, 0.0D, 0.0D, 0.0D);
        }
        else if (l == 2)
        {
        ...
        {
            par1World.spawnParticle("witchMagic", d0, d1 + d3, d2 - d4, 0.0D, 0.0D, 0.0D);
            par1World.spawnParticle("witchMagic", d0, d1 + d3, d2 - d4, 0.0D, 0.0D, 0.0D);
        }
        else if (l == 4)
        {
        ...
        {
            par1World.spawnParticle("witchMagic", d0, d1, d2, 0.0D, 0.0D, 0.0D);
            par1World.spawnParticle("witchMagic", d0, d1, d2, 0.0D, 0.0D, 0.0D);
        }
    }
}
