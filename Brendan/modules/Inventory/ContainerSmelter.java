...
import Brendan.modules.Crafting.RecipesSmelter;
...
public class ContainerSmelter extends Container
{
	...
	public ContainerSmelter(InventoryPlayer inventoryPlayer, TileEntitySmelter tileFurnace)
	{
		...
		this.addSlotToContainer(new Slot(tileFurnace, TileEntitySmelter.INGOT_SLOT_1_INDEX, 38, 17));
		this.addSlotToContainer(new Slot(tileFurnace, TileEntitySmelter.INGOT_SLOT_2_INDEX, 56, 17));
		this.addSlotToContainer(new Slot(tileFurnace, TileEntitySmelter.FUEL_INVENTORY_INDEX, 45, 53));
		this.addSlotToContainer(new Slot(tileFurnace, TileEntitySmelter.OUTPUT_INVENTORY_INDEX, 116, 35));
